----------------------------------------------------------
-- Minetest :: medevialic Flags Mod (medevial_flags)
--
-- See README.txt for licensing and other information
-- Code adapted from "pride_flags" mod by Leslie E. Krause
-- Copyright (c) 2022, BubbaFrog
--
-- ./games/minetest_game/mods/medevial_flags/init.lua
----------------------------------------------------------
...
local flag_list = { "jerusalem",   "templar", "celtic", "oldfrench", "rome", "irish", "scotish", "pirate", "teutonic", "french", "raven", "hungary", "lionheart", "norse", "oldegypt",}
...
minetest.register_entity( "medevial_flags:wavingflag", {
	initial_properties = {
		...
		pointable = false,
		mesh = "wavingflag.b3d",
		textures = { string.format( "medevial_flags_%s.png", flag_list[1] ) },
...
print( cur_wind )
	...
	reset_texture = function ( self, flag_idx )
		...
		local texture = string.format( "medevial_flags_%s.png", flag_list[ self.flag_idx ] )
...
minetest.register_node( "medevial_flags:lower_mast", {
...
minetest.register_node( "medevial_flags:upper_mast", {
	description = "Flag Pole",
	drawtype = "mesh",
	paramtype = "light",
	mesh = "mast_upper.obj",
	...
	on_construct = function ( pos )
		...
		local obj = minetest.add_entity( flag_pos, "medevial_flags:wavingflag" )
